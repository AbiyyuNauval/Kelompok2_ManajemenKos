                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <select name="role" id="role" class="w-full bg-slate-700 border border-slate-600 text-white rounded-md pl-10 pr-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500" required>
